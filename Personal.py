...
def handle_bgmi_command(message):
    ...
    bot.send_message(message.chat.id, "💣 अटैक शुरू करने के लिए तैयार?\n"
                                      ...
                                      "उदाहरण: `167.67.25 6296 260 ` 🔥", parse_mode='Markdown')
...
def process_bgmi_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration > 260:
            bot.send_message(message.chat.id, "⏳ अधिकतम समय 260 सेकंड है।", parse_mode='Markdown')
            return
        ...
        bot.send_message(message.chat.id, "Attack lag gya hai Screen shot lo busdike or send kar. @ILLEGALCHEAT78")
